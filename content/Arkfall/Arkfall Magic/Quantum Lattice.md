...
### Lattice Materium
Lattice Materium is Quantum Lattice given physical form such as Lattice that has crystallized, condensed, or otherwise bled into matter itself, found in places where reality has been placed under extreme stress. This could be anywhere from the cores of dead stars to collapsed interstellar superstructures. The location does not have to be so grand to have Lattice Materium, but the more intense the strain, the more Lattice Materium you will find. Lattice Materium is commonly referred to as: *lattice ore*, *quantum silt*, or *entangled dust*. This Materium is gathered through [[Lattice Mining]].
...
Sprite-Bound Lattice is Quantum Lattice synthesized within a living host by a [[Sprite]] (A sentient spirit of Lattice that has chosen or been bound to an individual). People bound with Sprites are known as [[Vector|Vectors]]. 

Unlike Materium, Sprite-Bound Lattice is neither raw or unstable by the time it is within its host. It is already shaped, refined, and tuned to the Vector's unique quantum signature by their Sprite. It can only be used by the Vector it was made for, unless they choose to imbue into someone or something else.

While vastly more versatile than Materium, Sprite-Bound Lattice is not free. A Sprite cannot synthesize it on command, it does so only when it feels its nature is satisfied, an act the Sprite considers an achievement. A warlike Sprite may demand battle or bloodshed, while a peaceful Sprite may demand protection or sacrifice. This makes Sprite-Bound Lattice deeply personal and quietly parasitic. A Vector's power is never fully their own, but a deal made with the Sprite they carry.

Where Materium can be stockpiled and armed en masse, Sprite-Bound Lattice cannot. It is singular, unrepeatable, and bound to the shared psychology of both Sprite and Vector. This is part of why Vectors remain rare champions and not common. Their power cannot be centralized, commanded, or mass-produces.
